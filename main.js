...
const translations = {
  en: {
    ...
    nav_experience: 'Experience', download_cv: '\u2193 CV',
    stats_years: '5+', stats_years_label: 'Years Experience',
    stats_industries: '3', stats_industries_label: 'Industries',
    stats_certs: '11', stats_certs_label: 'Certifications',
    stats_protocols: '2', stats_protocols_label: 'OCPP Versions',
    exp_title: 'Experience', certs_title: 'Certifications',
    ai_title: 'AI & Automation',
    ai_desc: 'Beyond traditional automation, I integrate AI tools into the testing workflow \u2014 from AI-assisted test generation to MCP server orchestration and prompt engineering for test scenarios. Staying ahead of the curve in AI-powered QA.',
    articles_title: 'Tech Insights',
    article1_tag: 'AI & ML', article1_title: 'AI Tokens \u2014 How LLMs Process Text',
    article1_desc: 'Deep dive into BPE tokenization, embedding spaces, context windows, and how language models generate text one token at a time.',
    article2_tag: 'Protocol Testing', article2_title: 'OCPP \u2014 Testing EV Charging Standards',
    article2_desc: 'Validating OCPP 1.6 & 2.0.1 bidirectional Websocket flows for EV charging infrastructure interoperability and roaming (OCPI).',
    article3_tag: 'QA Strategy', article3_title: 'Shift-Left Testing in SAFe Environments',
    article3_desc: 'Integrating quality assurance from the design phase with PO/Dev collaboration using Agile and SAFe methodologies to reduce bug escape rate.',
    coming_soon: 'Coming soon',
    contact_overline: "09. What's Next?", contact_title: 'Get In Touch',
  ...
  fr: {
    ...
    nav_experience: 'Expérience', download_cv: '\u2193 CV',
    stats_years: '5+', stats_years_label: "Années d'expérience",
    stats_industries: '3', stats_industries_label: 'Secteurs',
    stats_certs: '11', stats_certs_label: 'Certifications',
    stats_protocols: '2', stats_protocols_label: 'Versions OCPP',
    exp_title: 'Expérience', certs_title: 'Certifications',
    ai_title: 'IA & Automatisation',
    ai_desc: "Au-delà de l'automatisation traditionnelle, j'intègre les outils IA \u2014 génération de tests assistée par IA, orchestration de serveurs MCP et prompt engineering.",
    articles_title: 'Veille Technologique',
    article1_tag: 'IA & ML', article1_title: 'Tokens IA \u2014 Comment les LLMs traitent le texte',
    article1_desc: "Plongée dans la tokenisation BPE, les espaces d'embedding et les fenêtres de contexte.",
    article2_tag: 'Tests de protocoles', article2_title: 'OCPP \u2014 Tester les standards EV',
    article2_desc: 'Validation des flux Websocket OCPP 1.6 & 2.0.1 pour l\'interopérabilité EV et l\'itinérance (OCPI).',
    article3_tag: 'Stratégie QA', article3_title: 'Shift-Left Testing en environnements SAFe',
    article3_desc: "Intégration de l'assurance qualité dès la conception avec les méthodologies Agile et SAFe.",
    coming_soon: 'Bientôt disponible',
    contact_overline: '09. Et maintenant ?', contact_title: 'Prendre contact',
  ...
  bg: {
    ...
    nav_experience: 'Опит', download_cv: '\u2193 CV',
    stats_years: '5+', stats_years_label: 'Години опит',
    stats_industries: '3', stats_industries_label: 'Индустрии',
    stats_certs: '11', stats_certs_label: 'Сертификата',
    stats_protocols: '2', stats_protocols_label: 'OCPP версии',
    exp_title: 'Опит', certs_title: 'Сертификати',
    ai_title: 'ИИ и Автоматизация',
    ai_desc: 'Отвъд традиционната автоматизация, интегрирам AI инструменти \u2014 AI генериране на тестове, MCP оркестрация и prompt engineering.',
    articles_title: 'Технически прозрения',
    article1_tag: 'ИИ и МО', article1_title: 'AI токени \u2014 Как LLM обработват текст',
    article1_desc: 'Дълбоко гмуркане в BPE токенизация и контекстни прозорци.',
    article2_tag: 'Тестване на протоколи', article2_title: 'OCPP \u2014 Тестване на EV стандарти',
    article2_desc: 'Валидиране на OCPP 1.6 & 2.0.1 Websocket потоци за съвместимост и OCPI роуминг.',
    article3_tag: 'QA стратегия', article3_title: 'Shift-Left в SAFe среди',
    article3_desc: 'Интегриране на QA с Agile и SAFe методологии.',
    coming_soon: 'Очаквайте скоро',
    contact_overline: '09. Какво следва?', contact_title: 'Свържете се с мен',
